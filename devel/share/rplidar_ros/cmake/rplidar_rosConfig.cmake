...
if("TRUE" STREQUAL "TRUE")
  set(rplidar_ros_SOURCE_PREFIX /home/rical/rplidar_ros)
  set(rplidar_ros_DEVEL_PREFIX /home/rical/rplidar_ros/devel)
  ...
  set(rplidar_ros_INSTALL_PREFIX /usr)
...
if(NOT "/opt/ros/kinetic/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/arm-linux-gnueabihf/freetype2;/usr/include/arm-linux-gnueabihf;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/tcl " STREQUAL " ")
  set(rplidar_ros_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros/kinetic/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/arm-linux-gnueabihf/freetype2;/usr/include/arm-linux-gnueabihf;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rplidar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rical/rplidar_ros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rplidar_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "pcl_ros_filters;pcl_ros_io;pcl_ros_tf;sqlite3;dynamic_reconfigure_config_init_mutex;nodeletlib;bondcpp;class_loader;dl;roslib;rospack;rosbag;rosbag_storage;roslz4;topic_tools;tf;tf2_ros;actionlib;message_filters;roscpp;pthread;xmlrpcpp;tf2;roscpp_serialization;rosconsole;rosconsole_log4cxx;rosconsole_backend_interface;rostime;cpp_common")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rical/rplidar_ros/devel/lib;/home/rical/rplidar_ros/build/devel/lib;/opt/ros/kinetic/lib)
